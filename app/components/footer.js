        ...
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
              Limor is a Lorem, ipsum dolor sit amet consectetur adipisicing
              elit. Laudantium vero quibusdam molestiae explicabo quasi
              blanditiis vitae illum consequatur officiis nihil!
            </div>
          </div>
          ...
          <div className="">
            ...
            <div className="flex mt-5 space-x-5 text-gray-400 dark:text-gray-500">
              ...
              <a
                href="https://facebook.com/limoralfia"
                target="_blank"
                rel="noopener"
              >
              ...
              <a
                href="https://instagram.com/limoralfia"
                target="_blank"
                rel="noopener"
              >
